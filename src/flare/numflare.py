...
def encode_number(number, decimals=0, len_min=1, is_latitude=True, collapse_magnitude=False):
    """
...
if __name__ == "__main__":
    print("hello world!")
    n = 100
    s = encode_number(number=n, decimals=1, len_min=3, is_latitude=True, collapse_magnitude=True)
    print(s)
